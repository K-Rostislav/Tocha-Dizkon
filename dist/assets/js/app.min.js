function testWebP(e){let t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}testWebP(function(e){1==e?document.querySelector("html").classList.add("webp"):document.querySelector("html").classList.add("no-webp")});const btns=document.querySelectorAll(".violet-button, .pink-button");for(let r of btns)r.addEventListener("mouseover",e=>{var t=document.createElement("span");t.classList.add("hover"),Object.assign(t.style,{top:e.clientY-r.getBoundingClientRect().top+"px",left:e.clientX-r.getBoundingClientRect().left-4+"px"}),r.appendChild(t)}),r.addEventListener("mouseout",e=>{var t=e.target.querySelector(".active");t&&t.remove(),e.target.querySelector(".hover").remove()}),r.addEventListener("mousedown",e=>{const t=document.createElement("span");t.classList.add("active"),Object.assign(t.style,{top:e.clientY-r.getBoundingClientRect().top+"px",left:e.clientX-r.getBoundingClientRect().left-4+"px"}),r.appendChild(t),setTimeout(()=>{t.remove()},300)});const burgerBtn=document.querySelector(".burger-btn"),burgerBg=document.querySelector(".burger-background"),burger=document.querySelector(".burger"),close=document.querySelector(".close"),tocha=(burgerBtn.addEventListener("click",()=>{burgerBtn.classList.add("burger-btn_active"),burger.classList.add("burger_active"),burgerBg.classList.add("burger-background_active")}),burgerBg.addEventListener("click",()=>{burgerBtn.classList.remove("burger-btn_active"),burger.classList.remove("burger_active"),burgerBg.classList.remove("burger-background_active")}),close.addEventListener("click",()=>{burgerBtn.classList.remove("burger-btn_active"),burger.classList.remove("burger_active"),burgerBg.classList.remove("burger-background_active")}),document.querySelector(".tocha")),tochaSvg=document.querySelector(".tocha__svg"),email=document.querySelector(".email"),emailSvg=document.querySelector(".email__svg"),form=(window.addEventListener("scroll",()=>{var e=window.scrollY;e>tocha.getBoundingClientRect().top+e-600&&tochaSvg.classList.add("tocha__svg_animate"),e>email.getBoundingClientRect().top+e-500&&emailSvg.classList.add("email__svg_animate")}),new Swiper(".offers__slider",{spaceBetween:30,slidesPerView:3,grabCursor:!0,pagination:{el:".offers__slider-pagination",clickable:!0},breakpoints:{768:{slidesPerView:3},600:{slidesPerView:2,spaceBetween:20},0:{slidesPerView:1}},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0}}),new Swiper(".connection__slider",{spaceBetween:170,slidesPerView:3,grabCursor:!0,pagination:{el:".connection__slider-pagination",clickable:!0},breakpoints:{1024:{spaceBetween:100},768:{spaceBetween:27,slidesPerView:3},480:{slidesPerView:2},0:{spaceBetween:15,slidesPerView:1.5}},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0}}),new Swiper(".comments__slider",{spaceBetween:30,slidesPerView:2,grabCursor:!0,pagination:{el:".comments__slider-pagination",clickable:!0},breakpoints:{768:{slidesPerView:2},480:{slidesPerView:1.5},0:{slidesPerView:1}},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0}}),AOS.init({startEvent:"DOMContentLoaded",initClassName:"aos-init",animatedClassName:"aos-animate",useClassNames:!1,disableMutationObserver:!1,debounceDelay:50,throttleDelay:99,offset:200,delay:0,duration:500,easing:"ease",once:!0,mirror:!1,anchorPlacement:"top-bottom"}),document.getElementById("form")),inputBlock=document.querySelector(".input-block"),input=document.querySelector(".input-block__input"),btnSubmit=document.querySelector(".email__button");btnSubmit.addEventListener("click",e=>{e.preventDefault();/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9_-]+)/.test(input.value)?(inputBlock.classList.remove("input-block_error"),form.submit()):inputBlock.classList.add("input-block_error")});
...
!function(){const k={doc:{"background-color":"rgb(37, 37, 37)",color:"white",width:"90vw",height:"90vh",position:"fixed",top:"50%",left:"50%",transform:"translate(-50%, -50%)","border-radius":"30px",padding:"20px 30px","font-family":"Montserrat",dispaly:"flex","flex-direction":"column",overflow:"auto","z-index":"2000"},buttons:{display:"flex","column-gap":"20px","margin-bottom":"20px"},btn:{color:"white",padding:"10px 15px",border:"none","font-size":"16px","border-radius":"10px",cursor:"pointer",transition:"background-color .2s"},content:{fontSize:"16px",display:"none","flex-direction":"column"},accordGrid:{display:"grid","grid-template-columns":"repeat(3, 1fr)",gap:"20px","margin-bottom":"20px"},block:{border:"1px solid white","border-radius":"10px",padding:"20px",overflow:"auto","max-width":"530px",height:"350px","background-color":"rgb(37, 37, 37)"},code:{"text-align":"left","font-size":"14px"},accordionResult:{"max-width":"530px","margin-bottom":"40px"},burgerResult:{"max-width":"530px","margin-bottom":"40px",border:"1px solid white",padding:"20px","border-radius":"10px",height:"350px"},yellow:{color:"rgb(250, 219, 137)"},green:{color:"rgb(210, 250, 137)"},orange:{color:"rgb(252, 107, 3)"},purple:{color:"rgb(184, 129, 199)"},darkGreen:{color:"rgb(104, 173, 87)"},pink:{color:"rgb(250, 90, 191)"},blue:{color:"rgb(76, 155, 252)"}},v=[{className:"btn",dataTab:"accordion",text:"Аккордион",active:!0},{className:"btn",dataTab:"burger",text:"Меню бургер"},{className:"btn",dataTab:"modal",text:"Модальное окно"}];document.addEventListener("keydown",s=>{if(document.querySelector(".doc")||"F9"!==s.key)"F9"===s.key&&document.querySelector(".doc").remove();else{var a,n,s=document.createElement("div"),p=(Object.assign(s.style,k.doc),s.classList.add("doc"),document.body.appendChild(s),s.innerHTML=`
        <div class="buttons">
        </div>
        `,document.querySelector(".buttons"));Object.assign(p.style,k.buttons);for(a of v)p.innerHTML+=`
            <button style="${a.active?"background-color: rgb(120, 0, 224)":"background-color: rgb(67, 67, 67)"}" class="${a.className}" data-tab="${a.dataTab}">${a.text}</button>
            `;for(n of document.querySelectorAll(".doc .btn"))Object.assign(n.style,k.btn);s.innerHTML+=`
...
<span class="yellow">}</span>
        ...
        `;var l,e,c,o,r,t,d,i,s=document.querySelectorAll(".doc .content"),y=document.querySelector(".doc #accordion");for(l of s)Object.assign(l.style,k.content);y.style.display="flex";for(e of document.querySelectorAll(".doc .accrodion-grid"))Object.assign(e.style,k.accordGrid);for(c of document.querySelectorAll(".doc .block"))Object.assign(c.style,k.block);for(o of document.querySelectorAll(".doc .code"))Object.assign(o.style,k.code);for(r of document.querySelectorAll(".yellow, .green, .orange, .purple, .dark-green, .pink, .blue"))r.classList.contains("yellow")?Object.assign(r.style,k.yellow):r.classList.contains("green")?Object.assign(r.style,k.green):r.classList.contains("orange")?Object.assign(r.style,k.orange):r.classList.contains("purple")?Object.assign(r.style,k.purple):r.classList.contains("dark-green")?Object.assign(r.style,k.darkGreen):r.classList.contains("pink")?Object.assign(r.style,k.pink):r.classList.contains("blue")&&Object.assign(r.style,k.blue);for(t of document.querySelectorAll(".doc .accordion__result"))Object.assign(t.style,k.accordionResult);for(d of document.querySelectorAll(".doc .burger__result"))Object.assign(d.style,k.burgerResult);{const w=document.querySelectorAll(".btn");for(var g of w)g.addEventListener("click",s=>{var a,n,s=s.target,p=s.getAttribute("data-tab"),p=document.getElementById(p);for(a of w)a.style.backgroundColor="rgb(57, 57, 57)";s.style.backgroundColor="rgb(120, 0, 224)";for(n of document.querySelectorAll(".content"))n.style.display="none";p.style.display="flex"})}for(i of document.querySelectorAll(".doc .acc-result-1 [data-accord]"))i.addEventListener("click",s=>{s=s.target.getAttribute("data-accord");document.querySelector(".doc #"+s).style.display="flex"});{var u,s=document.querySelectorAll(".doc .acc-result-2 [data-accord]");const b=document.querySelectorAll(".doc .acc-result-2 .accordion__content");for(u of s)u.addEventListener("click",s=>{var a,s=s.target.getAttribute("data-accord");for(a of b)a.style.display="none";document.querySelector(".doc #"+s).style.display="flex"})}{y=document.querySelector(".doc .burger-result-1 #burger-btn");const m=document.querySelector(".doc .burger-result-1 #burger");let s=!0;y.addEventListener("click",()=>{s=s?!(m.style.transform="translateX(0)"):(m.style.transform="translateX(100%)",!0)})}}})}();
!function(){let d,n,o=[],l=!0,r,a,p,s,g=1;function u(i){const n=document.createElement("div");new Promise((e,t)=>{e(Object.assign(n.style,{"background-color":""+i,position:"absolute",color:"white","font-family":"Montserrat",display:"flex","flex-direction":"column","align-items":"flex-start","border-radius":"10px",padding:"10px",border:"1px solid white","z-index":"1003","pointer-events":"none",left:r+"px",top:a+"px"}),n.setAttribute("id","tablet"),n.innerHTML=2!==o.length?`
                    <div style="margin-left: auto;">${s.width} x ${s.height}</div>
                    <div style="margin-left: auto;">${p.fontFamily}</div>
                    <div style="margin-left: auto;">${p.fontSize}</div>
                    <div style="color: rgb(250, 219, 137);">${d.getAttribute("class")?"."+d.getAttribute("class"):""}</div>
                    <br>
                    <div style="color: rgb(66, 255, 255);">${"none"!==p.maxWidth?"max-width: "+p.maxWidth:""}</div>
                    <div style="color: rgb(66, 255, 255);">${"none"!==p.maxHeight?"max-height: "+p.maxHeight:""}</div>
                    <div style="color: rgb(66, 255, 255);">${"auto"!==p.minWidth&&"0px"!==p.minWidth?"min-width: "+p.minWidth:""}</div>
                    <div style="color: rgb(66, 255, 255);">${"auto"!==p.minHeight&&"0px"!==p.minHeight?"min-height: "+p.minHeight:""}</div>
                    <div style="color: rgb(122, 255, 167);">${"0px"!==p.margin?"margin: "+p.margin:""}</div>
                    <div style="color: rgb(122, 255, 167);">${"0px"!==p.padding?"padding: "+p.padding:""}</div>
                    <div style="color: rgb(122, 255, 167);">${"0px"!==p.margin?"margin: "+p.margin:""}</div>
                    <div style="color: rgb(255, 130, 130);">${"flex"===p.display?"display: "+p.display:""}</div>
                    <div style="color: rgb(255, 130, 130);">${"column"===p.flexDirection?"flex-direction: "+p.flexDirection:""}</div>
                    <div style="color: rgb(255, 130, 130);">${"normal"!==p.justifyContent?"justify-content: "+p.justifyContent:""}</div>
                    <div style="color: rgb(195, 135, 255);">${"grid"===p.display?"display: "+p.display:""}</div>
                    <div style="color: rgb(195, 135, 255);">${"none"!==p.gridTemplateColumns?"grid-template-columns: "+p.gridTemplateColumns:""}</div>
                    <div style="color: rgb(195, 135, 255);">${"auto"!==p.justifySelf?"justify-self: "+p.justifySelf:""}</div>
                    <div style="color: rgb(195, 135, 255);">${"auto"!==p.alignSelf?"align-self: "+p.alignSelf:""}</div>
                    <div style="${"grid"===p.display?"color: rgb(195, 135, 255)":"color: rgb(255, 130, 130)"};">${"normal"!==p.gap?"gap: "+p.gap:""}</div>
                    `:`
                    <div>${f()}</div>
                    `,document.body.appendChild(n))}).then(()=>{c()})}function c(){const t=document.getElementById("tablet"),i=document.getElementById("edit-tablet");window.addEventListener("mousemove",e=>{Object.assign(t.style,{left:e.pageX+30+"px",top:e.pageY+"px"}),r=e.pageX+30,a=e.pageY-20,i&&Object.assign(i.style,{left:e.pageX-225+"px",top:e.pageY+"px"})})}function f(){var e=[];if("d"===n){if(o[0].offsetLeft<o[1].offsetLeft)return e.push(o[0].getBoundingClientRect().right),e.push(o[1].getBoundingClientRect().left),`x : ${Math.max.apply(null,e)-Math.min.apply(null,e)}px`;if(o[0].offsetLeft>o[1].offsetLeft)return e.push(o[0].getBoundingClientRect().left),e.push(o[1].getBoundingClientRect().right),`x : ${Math.max.apply(null,e)-Math.min.apply(null,e)}px`}if("w"===n)return o[0].offsetTop<o[1].offsetTop?(e.push(o[0].getBoundingClientRect().bottom),e.push(o[1].getBoundingClientRect().top),`y : ${Math.max.apply(null,e)-Math.min.apply(null,e)}px`):o[0].offsetTop>o[1].offsetTop?(e.push(o[0].getBoundingClientRect().top),e.push(o[1].getBoundingClientRect().bottom),`y : ${Math.max.apply(null,e)-Math.min.apply(null,e)}px`):void 0}function h(){var e=document.createElement("div"),t=document.createElement("div");e.setAttribute("id","padding"),Object.assign(e.style,{width:s.width+"px",height:s.height+"px",position:"absolute",left:window.pageXOffset+s.left+"px",top:window.pageYOffset+s.top+"px","pointer-events":"none",border:"solid rgb(122, 255, 167, 0.53)","z-index":"1001","border-width":""+p.padding}),e.appendChild(t),document.body.appendChild(e)}function m(){var e,t=document.createElement("div"),i=document.createElement("div"),n=[];t.setAttribute("id","flex"),Object.assign(t.style,{width:s.width+"px",height:s.height+"px",position:"absolute",left:window.pageXOffset+s.left+"px",top:window.pageYOffset+s.top+"px",padding:""+(p.padding??0),"pointer-events":"none","z-index":"1001"}),Object.assign(i.style,{width:"100%",height:"100%",gap:""+p.gap,"pointer-events":"none",overflow:"auto",display:"flex","justify-content":""+p.justifyContent,"flex-direction":""+p.flexDirection,"align-items":""+p.alignItems,"background-color":"rgb(255, 133, 133, 0.53)"});for(e of d.children)"none"!==window.getComputedStyle(e,null).display&&n.push(e);for(let e=0;e<n.length;e++){var o=window.getComputedStyle(n[e],null);i.innerHTML+=`
                <div style="min-width: ${n[e].getBoundingClientRect().width}px; margin: ${o.margin}; height: ${n[e].getBoundingClientRect().height}px; background-color: rgb(255, 133, 133, 0.2); border: 3px dashed rgb(255, 133, 133, 1);"></div>
            `}t.appendChild(i),document.body.appendChild(t)}function y(){var e,t=document.createElement("div"),i=document.createElement("div"),n=[],o=[];t.setAttribute("id","grid"),Object.assign(t.style,{width:s.width+"px",height:s.height+"px",padding:""+p.padding,position:"absolute","pointer-events":"none","z-index":"1001",left:window.pageXOffset+s.left+"px",top:window.pageYOffset+s.top+"px"}),Object.assign(i.style,{width:"100%",height:"100%",gap:""+p.gap,"pointer-events":"none",display:"grid","grid-template-columns":""+p.gridTemplateColumns,"background-color":"rgb(181, 107, 255, 0.53)"});for(e of d.children)"none"!==window.getComputedStyle(e,null).display&&"tablet"!==e.getAttribute("id")&&"line"!==e.getAttribute("id")&&n.push(e);for(let e=0;e<n.length;e++)o.push(n[e].getBoundingClientRect().height),i.innerHTML+=`
                <div style="width: 100%; background-color: rgb(181, 127, 255, 0.2); height: ${Math.max.apply(null,o)}px; border: 3px dashed rgb(181, 127, 255);"></div>
            `;t.appendChild(i),document.body.appendChild(t)}function b(){var e,t,i=document.querySelectorAll("section, .header"),n=document.querySelector(".container"),o=document.createElement("div"),d=(o.setAttribute("id","line"),[]),l=[];Object.assign(o.style,{width:"100%",height:"100vh","pointer-events":"none",position:"absolute",top:"0",left:"0"});for(e of i)d.push(e.offsetTop+e.offsetHeight);for(t of d){var r=document.createElement("div");Object.assign(r.style,{width:"100%",height:"2px","background-color":"red",position:"absolute",top:t+"px"}),o.appendChild(r)}if(n){l.push(n.getBoundingClientRect().left,n.getBoundingClientRect().left+n.getBoundingClientRect().width);for(var a of l){var p=document.createElement("div");Object.assign(p.style,{width:"2px",height:document.body.offsetHeight+"px","background-color":"red",position:"absolute",left:a+"px"}),o.appendChild(p)}}document.body.appendChild(o)}function v(){var e=document.querySelectorAll("#tablet");if(e)for(var t of e)t.remove()}function x(){var e;for(e of document.querySelectorAll("#padding, #grid, #flex"))e.remove()}function w(){var e=document.querySelector("#blue");e&&e.remove()}function C(){var e=document.querySelectorAll("#edit-tablet");if(e)for(var t of e)t.remove()}function $(){var e=document.querySelectorAll("#line");if(e)for(var t of e)t.remove()}document.onkeydown=function(e){"x"===e.key&&l&&(o.push(d),d.style.outline="3px solid red",d.setAttribute("id","red"),n=e.key,2==(o=2<o.length?[]:o).length)&&(l=!1,v());if("z"===e.key&&!document.getElementById("edit-tablet")){for(var t of o)t.removeAttribute("style"),t.removeAttribute("id");v(),x(),l=!0,o=[]}"d"===e.key&&2===o.length&&(n=e.key,u("red"),f());"w"===e.key&&2===o.length&&(n=e.key,u("red"),f());"r"!==e.key||document.getElementById("edit-tablet")||setTimeout(()=>{var e,t;e=document.createElement("div"),t=document.createElement("textarea"),e.setAttribute("id","edit-tablet"),Object.assign(e.style,{"background-color":"rgb(71, 71, 71)",position:"absolute",color:"white","font-family":"Montserrat",display:"flex","flex-direction":"column","align-items":"flex-start","border-radius":"10px",padding:"10px",border:"1px solid white","z-index":"1003","pointer-events":"none",left:r-30-225+"px",top:a+20+"px"}),Object.assign(t.style,{height:"100px","background-color":"rgb(105, 105, 105)",color:"white",padding:"10px","border-radius":"5px"}),e.appendChild(t),document.body.appendChild(e),t.focus(),console.log(d.innerHTML),c()},1);{var i;"Control"===e.key&&(i=document.getElementById("edit-tablet").firstChild,d.setAttribute("style",""+i.value),x(),i.value.includes("display: flex;")&&m(),i.value.includes("display: grid;")&&y(),h())}"c"===e.key&&(l=l?($(),!1):(setTimeout(()=>{b()},10),!0));"F8"===e.key&&($(),v(),w(),x(),C(),2===(g=2<++g?1:g))&&b();"v"===e.key&&(d.style.pointerEvents="none")},2!==g&&(document.onmouseover=document.onmouseout=function(e){var t;1===g?($(),v(),w(),x(),C()):(t=e.target).closest(".doc")||["page","main"].includes(t.getAttribute("class"))||("mouseover"!==e.type?(2!==o.length&&v(),w(),x(),C()):(d=t,p=window.getComputedStyle(d,null),s=d.getBoundingClientRect(),o.includes(d)||2===o.length||"grid"===p.display||"flex"===p.display||(e=document.createElement("div"),t=document.createElement("div"),e.setAttribute("id","blue"),Object.assign(e.style,{width:s.width+"px",height:s.height+"px",position:"absolute",padding:""+p.padding,left:window.pageXOffset+s.left+"px",top:window.pageYOffset+s.top+"px","pointer-events":"none","z-index":"1002"}),Object.assign(t.style,{width:"100%",height:"100%","pointer-events":"none","background-color":"rgb(87, 165, 255, 0.5)"}),e.appendChild(t),document.body.appendChild(e)),2!==o.length&&u("rgb(71, 71, 71)"),"0px"!==p.padding&&2!==o.length&&h(),"flex"===p.display&&m(),"grid"===p.display&&y()))})}();